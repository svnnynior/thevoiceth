d3.queue()
    .defer(d3.csv, "../data/pickrategenre.csv")
    .await(ready)
...
function ready(error, data) {
  ...
  drawPickRateGenre_Kong(data_kong)
  drawPickRateGenre_Joey(data_joey)
  drawPickRateGenre_Kim(data_kim)
  drawPickRateGenre_Stamp(data_stamp)
  drawPickRateGenre_Singto(data_singto)
  drawPickRateGenre_Da(data_da)
...
function drawPickRateGenre_Kong(data){
  ...
  function draw_inside_graph4(){
    ...
    texts.enter().append("text")
      .attr("x", function (d) { return x(d.genre) + 5})
...
function drawPickRateGenre_Stamp(data){

  var max = d3.max(data, function (d) { return d.percentage })
  var svg_graph_age_stamp = d3.select("#chartPickRateGenre_Stamp").append("svg")
...
function drawPickRateGenre_Kim(data){

  var max = d3.max(data, function (d) { return d.percentage })
  var svg_graph_age_kim = d3.select("#chartPickRateGenre_Kim").append("svg")
...
function drawPickRateGenre_Joey(data){

  var max = d3.max(data, function (d) { return d.percentage })
  var svg_graph_age_joey = d3.select("#chartPickRateGenre_Joey").append("svg")
...
function drawPickRateGenre_Singto(data){

  var max = d3.max(data, function (d) { return d.percentage })
  var svg_graph_age_singto = d3.select("#chartPickRateGenre_Singto").append("svg")
...
function drawPickRateGenre_Da(data){

  var max = d3.max(data, function (d) { return d.percentage })
  var svg_graph_age_da = d3.select("#chartPickRateGenre_Da").append("svg")
